#!/bin/bash
#   OmenKube - Manage multiple K8 servers through SSH in one go
#
#   Copyright © 2025, Rodrigo Ernesto Alvarez Aguilera <incognia@gmail.com>
#
...
#
#   Tested under Ubuntu 24.04.2 LTS using GNU bash version 5.2.21
#
